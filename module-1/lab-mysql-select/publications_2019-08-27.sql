...
# Dump of table employee2
# ------------------------------------------------------------

DROP TABLE IF EXISTS `employee2`;

CREATE TABLE `employee2` (
  `emp_id` text COLLATE utf8mb4_general_ci,
  `fname` text COLLATE utf8mb4_general_ci,
  `minit` text COLLATE utf8mb4_general_ci,
  `lname` text COLLATE utf8mb4_general_ci,
  `job_id` bigint(20) DEFAULT NULL,
  `job_lvl` bigint(20) DEFAULT NULL,
  `pub_id` text COLLATE utf8mb4_general_ci,
...
INSERT INTO `employee2` (`emp_id`, `fname`, `minit`, `lname`, `job_id`, `job_lvl`, `pub_id`, `hire_date`)
VALUES
	('A-C71970F','Aria','','Cruz',10,87,'1389','1991-10-26 00:00:00'),
	('A-R89858F','Annette','','Roulet',6,152,'9999','1990-02-21 00:00:00'),
	('AMD15433F','Ann','M','Devon',3,200,'9952','1991-07-16 00:00:00'),
...
VALUES
	...
	(15,'Data Analyst/Data Scientist',10,20);
...
INSERT INTO `Test` (`au_id`, `au_lname`, `au_fname`, `phone`, `address`, `city`, `state`, `zip`, `contract`)
VALUES
	('','','','',NULL,NULL,NULL,NULL,0),
	('172-32-1176','White','Johnson','408 496-7223','10932 Bigge Rd.','Menlo Park','CA','94025',1),
	('213-46-8915','Green','Marjorie','415 986-7020','309 63rd St. #411','Oakland','CA','94618',1),
...
--
-- Dumping routines (PROCEDURE) for database 'publications'
--
DELIMITER ;;

# Dump of PROCEDURE author_data
# ------------------------------------------------------------

/*!50003 DROP PROCEDURE IF EXISTS `author_data` */;;
...
/*!50003 CREATE*/ /*!50020 DEFINER=`root`@`localhost`*/ /*!50003 PROCEDURE `author_data`()
begin
